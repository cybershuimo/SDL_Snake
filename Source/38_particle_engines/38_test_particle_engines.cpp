...
LTexture gShimmerTexture;   // to make particles look like shining
...
{
    return mFrame > 10; // rendered for a max of 10 frames
}
...
void Dot::renderParticles()
{
    for (int i = 0; i < TOTAL_PARTICLES; ++i)
    {
        // check if particle dead already
