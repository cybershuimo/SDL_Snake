...
bool init()
{
	...
	{
		//Create window
        gWindow = SDL_CreateWindow( "SDL Tutorial_07", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
        if( gWindow == NULL )
        {
	...
	else
	{
		...
		{	
			...
			while( !quit )
			{
				...
				//Render the JPG image texture to screen
