...
bool init()
{
    ...
    {
        //Create window
        gWindow = SDL_CreateWindow( "SDL Test_18", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
        if( gWindow == NULL )
        {
...
bool loadMedia()
{
    ...
    {
        printf( "Failed to load up sprite sheet texture!\n" );
        success = false;
    }
    else if ( !gDownTexture.loadFromFile( "18_key_states/down.png" ) )
    {
        printf( "Failed to load down sprite sheet texture!\n" );
        success = false;
    }
    else if ( !gLeftTexture.loadFromFile( "18_key_states/left.png" ) )
    {
        printf( "Failed to load left sprite sheet texture!\n" );
        success = false;
    }
    else if ( !gRightTexture.loadFromFile( "18_key_states/right.png" ) )
    {
        printf( "Failed to load right sprite sheet texture!\n" );
        success = false;
    }
    else if ( !gPressTexture.loadFromFile( "18_key_states/press.png" ) )
    {
        printf( "Failed to load press sprite sheet texture!\n" );
        success = false;
    }
